...
function Navigation() {
    ...
    return(
            <div className = "w-full h-full bg-[#0F172A] flex justify-center text-center cursor-pointer">
                <div
                    className = "w-1/6 h-full flex items-center [writing-mode:vertical-lr] justify-center border-gray-200 border-2 hover:w-2/6 duration-700 text-6xl font-black"
                    onClick = {() => redirect("/")}
                    >
                ...
                <div
                    className = "w-1/6 h-full flex items-center justify-center border-2 [writing-mode:vertical-lr] hover:w-2/6 duration-700 text-6xl font-black"
                    onClick = {() => redirect("/About")}>
                    <p className = "text-[#72E2AE]">0.2</p>
                    <h1 className = "text-[#FAFAFA] hover:text-[#72E2AE] mt-3">About</h1>
                </div>
                <div
                    className = "w-1/6 h-full flex items-center justify-center [writing-mode:vertical-lr] border-2 hover:w-2/6 duration-700 text-6xl font-black"
                ...
                <div
                    className = "w-1/6 h-full flex items-center justify-center [writing-mode:vertical-lr] border-2 hover:w-2/6 duration-700  font-black"
