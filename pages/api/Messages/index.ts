...
//     {
//         try {
//             messageCollection.find({}).lean().exec((err : Error | null,messages : any) => {
...
//             messageCollection.findOneAndUpdate(query,update,options,function(err : Error | null,result:any){
